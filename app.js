...
uk: {
  ...
  'proj.c3h':'Автоматизація пошуку роботи',
  'proj.c3p':'Агент за розкладом, який щодня шукає вакансії через API, фільтрує за відповідністю профілю, веде облік у таблиці та генерує підлаштоване резюме й кавер-лист під кожну відповідну позицію.',
  'proj.c4h':'Власні плагіни та скіли',
  'proj.c4p':'Багаторазові скіли й плагіни, які пакують воркфлоу один раз і потім виконують його стабільно щоразу — будівельні блоки, які я використовую в клієнтських автоматизаціях, відкриті для повторного використання.',
...
sv: {
  ...
  'proj.c3h':'Automatiserad jobbsökning',
  'proj.c3p':'En schemalagd agent som dagligen söker jobb via API:er, filtrerar utifrån profilmatchning, håller ordning i ett kalkylark och genererar ett skräddarsytt CV och personligt brev för varje matchande roll.',
  'proj.c4h':'Egna plugins & skills',
  'proj.c4p':'Återanvändbara skills och plugins som paketerar ett arbetsflöde en gång och sedan kör det tillförlitligt varje gång — byggstenarna jag använder i kundautomatiseringar, släppta för vem som helst att återanvända.',
